...
**Feedback** <br>
Tijdens de presentatie[^5] waren de meningen erg positief. De stakeholders vonden dat de feedback die voorgaande oplevering gegeven was goed was verwerkt.

De manier waarop de voorspelling worden gevisualiseerd is op deze manier beter en spoort aan om de situatie aan te passen, indien nodig.
...
De front-end implementatie verliep niet zo soepel. Ik ben erg lang bezig geweest om met Chart.js mooie grafieken te maken. Aangezien ik hier nog geen ervaring mee had ging het erg moeizaam. Daarnaast ging door een update aan het package de date parsing kapot. Momenteel heb ik dit handmatig opgelost maar dit resulteert not niet in de gewenste grafieken.
